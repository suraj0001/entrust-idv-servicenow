...
VerificationSettingsAjax.prototype = Object.extendsObject(
    global.AbstractAjaxProcessor,
    {
        ...
        saveConfig: function () {
            try {
                var verificationSettingsService = require(
                ...
                var input = {
                    ...
                    deliveryChannel: this.getParameter(
                        'sysparm_delivery_channel',
                    ),
                    webhookSecret: this.getParameter(
                ...
                var result =
                    verificationSettingsService.saveVerificationSettings(input)

                return JSON.stringify(result)
            } catch (e) {
                gs.error(
                    '[Entrust IDV] Failed to save verification settings: ' +
                        e.message,
                )
