...
EntrustIDVSetupAjax.prototype = Object.extendsObject(
    global.AbstractAjaxProcessor,
    {
        ...
        testConnection: function () {
            try {
                ...
                gs.error(
                    '[EntrustIDV] EntrustIDVSetupAjax.testConnection failed: ' +
                        e,
                )
                return JSON.stringify({
                    success: false,
        ...
        getAliasInfo: function () {
            try {
                ...
                gs.error(
                    '[EntrustIDV] EntrustIDVSetupAjax.getAliasInfo failed: ' +
                        e,
                )
                return JSON.stringify({
                    success: false,
        ...
        getConfig: function () {
            try {
                ...
                gs.error(
                    '[EntrustIDV] EntrustIDVSetupAjax.getConfig failed: ' + e,
                )
                return JSON.stringify({
                    success: false,
                    message: 'Server error: ' + e,
        ...
        saveConfig: function () {
            try {
                ...
                gs.error(
                    '[EntrustIDV] EntrustIDVSetupAjax.saveConfig failed: ' + e,
                )
                return JSON.stringify({
                    success: false,
                    message: 'Server error: ' + e,
